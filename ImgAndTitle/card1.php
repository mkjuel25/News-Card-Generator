        ...
        document.getElementById('urlForm').addEventListener('submit', async function(event) {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    const cardHtml = `
                        <div id="${cardId}" class="bg-gray-100 overflow-hidden relative shadow-md rounded-lg transform transition duration-300 hover:scale-105">
                            <a href="${data.original_url}" target="_blank" rel="noopener noreferrer">
                                <div class="card-img-container">
                                    ...
                                    <div class="card-overlay">
                                        <h2 class="font-bold text-white mb-2 leading-tight">${displayHeadline}</h2>
